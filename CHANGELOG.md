...
All notable HoursFlow — Business Hours CTA changes are documented here.

## 0.1.0 - 2026-09-13

- Initial release of the schedule-aware HoursFlow — Business Hours CTA shortcode and dynamic block.
...
- Added explicit per-state status hiding for blocks and the exact
  `[hoursflow_cta hide_status="1"]` shortcode attribute, with selected-state
